...
<!DOCTYPE html>
<html>
<?php $title="kurdistanBloodbank | Blood Samples"; ?>
...
<body>
    ...
    <div class="container cont">
        ...
        <div class="row col-lg-8 col-md-8 col-sm-12 mb-3">
            ...
            <label class="font-weight-bolder">Blood Group:</label>
        ...
        <table class="table table-responsive table-striped rounded mb-5">
            <tr><th colspan="7" class="title">All Blood Samples</th></tr>
            <tr>
                <th>Number</th>
                <th>Hospital Name</th>
                <th>Hospital City</th>
            ...
            <div>
                ...
                }else echo '<b style="color:white;background-color:red;padding:9px;border-radius: 4px 40px;">Nothing :( </b>';
            }
            ?>
            </div>
        ...
        <?php while($row = mysqli_fetch_array($result)) { ?>
            ...
            <tr>
                ...
                <td><a href="javascript:void(0);" class="btn btn-info hospital">Request Blood Sample</a></td>
...
<script type="text/javascript">
    $('.hospital').on('click', function(){
        alert("sorry Hospital user can't request for blood :(");
    });
</script>
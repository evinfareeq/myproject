...
<!DOCTYPE html>
<html>
<?php $title="kurdistanBloodbank | Add blood samples"; ?>
    ...
    <div class="container cont">
      ...
      <div class="row justify-content-center">
         ...
         <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          <div class="card">
            <div class="card-header title">Add blood group</div>
        <div class="card-body">
  ...
  ?>
    <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          <table class="table table-striped table-responsive">
            <th colspan="4" class="title">Kurdistan Blood Bank</th>
            <tr>
              <th>Number</th>
            ...
            <div>
                ...
                }else echo '<b style="color:white;background-color:red;padding:7px;border-radius: 15px 50px;">Nothing</b>';
            }
            ?>
            </div>

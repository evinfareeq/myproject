...
<!DOCTYPE html>
<html>
<?php $title="kurdistanBloodbank | Receiver Profile"; ?>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 mb-5">
				<div class="card">
					<div class="media justify-content-center mt-1">
						<img src="image/hospital-512.webp" alt="profile" class="rounded-circle" width="70" height="60">
					</div>
					<div class="card-body">
					   <form action="file/updateprofile.php" method="post">
						...
						<label class="text-muted font-weight-bold">Hospital E-mail</label>
